...
double sin (double);
double cos (double);
double ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_cabs (cmplx *);
void cadd ( cmplx *, cmplx *, cmplx * );
void cmul ( cmplx *, cmplx *, cmplx * );
void ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_csqrt ( cmplx *, cmplx * );
...
static double ctans();
double ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_cabs(), fabs(), sqrt(), pow();
double log(), exp(), atan2(), cosh(), sinh();
double asin(), sin(), cos();
void cadd(), cmul(), ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_csqrt();
...
rr = ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_cabs(z);
p = log(rr);
#if ANSIC
rr = atan2( z->i, z->r );
#else
 ...
 *
 *                               2
 * w = -i clog( iz + ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_csqrt( 1 - z ) ).
 *
 *
 * ACCURACY:
 *
...
/*
b = ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_cabs(z);
if( b < 0.125 )
{
z2.r = (x - y) * (x + y);
z2.i = 2.0 * x * y;
...
zz.r = 1.0 - zz.r;
zz.i = -zz.i;
ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_csqrt( &zz, &z2 );
...
cpow (cmplx *a, cmplx *z, cmplx *w)
{
  ...
  x = z->r;
  y = z->i;
  absa = ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_ncephes_cabs (a);
  if (absa == 0.0)
    {
      w->r = 0.0;
      w->i = 0.0;
