...
double sin (double);
double cos (double);
double ncephes_ncephes_cabs (cmplx *);
void cadd ( cmplx *, cmplx *, cmplx * );
void cmul ( cmplx *, cmplx *, cmplx * );
void ncephes_ncephes_csqrt ( cmplx *, cmplx * );
...
static double ctans();
double ncephes_ncephes_cabs(), fabs(), sqrt(), pow();
double log(), exp(), atan2(), cosh(), sinh();
double asin(), sin(), cos();
void cadd(), cmul(), ncephes_ncephes_csqrt();
 ...
 *
 *                               2
 * w = -i clog( iz + ncephes_ncephes_csqrt( 1 - z ) ).
 *
 *
 * ACCURACY:
 *
