 ...
 */
void 
polclr (register double *a, int n)
{
int i;
 ...
 */
void 
polmov (register double *a, int na, register double *b)
{
int i;
 ...
 */
void 
polmul (double a[], int na, double b[], int nb, double c[])
{
int i, j, k, nc;
double x;
 ...
 */
void 
poladd (double a[], int na, double b[], int nb, double c[])
{
int i, n;
 ...
 */
void 
polsub (double a[], int na, double b[], int nb, double c[])
{
int i, n;
 ...
 */
int 
poldiv (double a[], int na, double b[], int nb, double c[])
{
double quot;
double *ta, *tb, *tq;
int i, j, k, sing;
...
void 
polsbt (double a[], int na, double b[], int nb, double c[])
{
int i, j, k, n2;
double x;
 ...
 */
double 
poleva (double a[], int na, double x)
{
double s;
int i;
